...
@torch.no_grad()
def improve_encodings(path_to_existing, noise_std=1.0, blend_factor=1.0):
    ...
    z = z_existing + noise
    z = manifold.projx(z)
    z_improved = integrate_flow(z, steps=1000, start_t=0.0)  # Start close to the end of the flow
